...
class MongoDriver extends core_1.DatabaseDriver {
    ...
    async nativeUpdate(entityName, where, data, options = {}) {
        ...
        where = this.renameFields(entityName, where, true);
        data = this.renameFields(entityName, data);
        return this.rethrow(this.getConnection('write').updateMany(entityName, where, data, options.ctx, options.upsert));
    }
    async nativeUpdateMany(entityName, where, data, options = {}) {
        ...
        return this.rethrow(this.getConnection('write').bulkUpdateMany(entityName, where, data, options.ctx, options.upsert));
    }
