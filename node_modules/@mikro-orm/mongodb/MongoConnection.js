...
class MongoConnection extends core_1.Connection {
    ...
    async updateMany(collection, where, data, ctx, upsert) {
        return this.runQuery('updateMany', collection, data, where, ctx, upsert);
    }
    async bulkUpdateMany(collection, where, data, ctx, upsert) {
        return this.runQuery('bulkUpdateMany', collection, data, where, ctx, upsert);
    }
    ...
    async runQuery(method, collection, data, where, ctx, upsert) {
        collection = this.getCollectionName(collection);
