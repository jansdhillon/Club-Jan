...
import type { EntityData, FilterQuery, Configuration, FindOneOptions, FindOptions, QueryResult, Transaction, IDatabaseDriver, PopulateOptions, CountOptions, EntityDictionary, EntityField, NativeInsertUpdateOptions, NativeInsertUpdateManyOptions } from '@mikro-orm/core';
...
export declare class MongoDriver extends DatabaseDriver<MongoConnection> {
    ...
    nativeUpdateMany<T extends object>(entityName: string, where: FilterQuery<T>[], data: EntityDictionary<T>[], options?: NativeInsertUpdateOptions<T>): Promise<QueryResult<T>>;
