import type { ClientSession, Collection, Db, MongoClientOptions, TransactionOptions } from 'mongodb';
import { MongoClient } from 'mongodb';
import type { AnyEntity, Configuration, ConnectionConfig, ConnectionOptions, ConnectionType, EntityData, EntityName, FilterQuery, IsolationLevel, QueryOrderMap, QueryResult, Transaction, TransactionEventBroadcaster } from '@mikro-orm/core';
...
export declare class MongoConnection extends Connection {
    ...
    updateMany<T extends object>(collection: string, where: FilterQuery<T>, data: Partial<T>, ctx?: Transaction<ClientSession>, upsert?: boolean): Promise<QueryResult<T>>;
    bulkUpdateMany<T extends object>(collection: string, where: FilterQuery<T>[], data: Partial<T>[], ctx?: Transaction<ClientSession>, upsert?: boolean): Promise<QueryResult<T>>;
